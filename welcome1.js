...
if (screen.width <= 1023) {
 ...
 document.getElementById('ftr').innerHTML =`<div class=" pb-5">
  ...
  <img src="pngfind.com-instagram-png-white-2773517 (1).png" class="logos-i pb-3" alt="">
    ...
    <div class="d-inline-block bold f-l"> © 2023 TrainTrippers All rights reserved <br> <div class="d-inline-block text-light fw-light f-s bold float-end"> Designed and built with all the love in the world by <a href="https://www.instagram.com/mysticalmanav/">Manav</a>.
    </div></div>`
